import { ExternalLink, Github, LineChart, Package, BarChart3 } from 'lucide-react';
...
const projects = [
  {
    ...
    github: '#',
    demo: '#',
    powerbiLink: '<iframe title="Analise de Vendas" width="600" height="486" src="https://app.powerbi.com/view?r=eyJrIjoiN2FlZTJhMTYtNGUwZS00ODA0LWJiNDgtZjU2MmUxMGUwYWM1IiwidCI6IjM1YTRlNGUxLWIyZDUtNGIxNC1hMTVjLTY0MjA2MTk0OGY0NCJ9&pageName=f22c8ff147d0934b057a" frameborder="0" allowFullScreen="true"></iframe>' // Substitua pelo link do seu relatório
  },
  {
    ...
    github: '#',
    demo: '#',
    powerbiLink: 'https://app.powerbi.com/view?r=OUTRO_LINK_AQUI' // Outro link de exemplo
  },
  {
